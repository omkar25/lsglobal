      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          ...
          <div className="flex gap-4">
            <span className="text-4xl font-light text-[#D28E45]">01</span>
            <div>
          ...
          {/* Strength 2 */}
          <div className="flex gap-4">
            <span className="text-4xl font-light text-[#D28E45]">02</span>
            <div>
              <h3 className="text-lg font-bold text-[#313639] mb-2">
                {t("strength2Title")}
              </h3>
          ...
          {/* Strength 3 */}
          <div className="flex gap-4">
            <span className="text-4xl font-light text-[#D28E45]">03</span>
            <div>
              <h3 className="text-lg font-bold text-[#313639] mb-2">
                {t("strength3Title")}
              </h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
          ...
          <div className="space-y-6">
            ...
            {/* Title */}
            <h2 className="text-3xl md:text-4xl font-bold text-[#313639] leading-tight">
              {t("successTitle1")}
              <br />
              {t("successTitle2")}{" "}
            ...
            <Link
              href="/about"
              className="inline-block px-8 py-3 border-2 border-[#D28E45] text-[#313639] font-semibold hover:bg-[#D28E45] hover:text-white transition-all duration-300"
            >
              {t("aboutUs")}
            </Link>
          </div>
            ...
            <div className="text-center">
              <div className="relative w-32 h-32 mx-auto mb-4">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-2xl font-bold text-[#313639]">
